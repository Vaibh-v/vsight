...
function Sparkline({ points, max }: { points: number[]; max?: number }) {
  ...
  const m = Math.max(...points, 1, max ?? 0);
    ...
    <main className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
        <div className="border rounded p-3">
          <div className="font-medium">GA4 Sessions (by day)</div>
          <Sparkline points={gaSessions} />
        </div>
        <div className="border rounded p-3">
          <div className="font-medium">GA4 Active Users (by day)</div>
          <Sparkline points={gaUsers} />
        </div>
        <div className="border rounded p-3">
          <div className="font-medium">GSC Clicks (by day)</div>
          <Sparkline points={gscClicks} />
        </div>
        <div className="border rounded p-3">
          <div className="font-medium">GSC Impressions (by day)</div>
          <Sparkline points={gscImpr} />
        </div>
      </div>
